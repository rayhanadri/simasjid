      ...
      <nav class="navbar navbar-expand-lg main-navbar">
        ...
        <ul class="navbar-nav navbar-right">
          ...
          <li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
              ...
              <div class="d-sm-none d-lg-inline-block"><?php echo $namaAnggota = $result['data_anggota']['namaAnggota']; ?></div>
            </a>
      ...
      <div class="main-sidebar">
        <aside id="sidebar-wrapper">
          <div class="sidebar-brand">
            <a href="{{ route('homePage') }}">SI MASJID IBNU SINA</a>
          </div>
          <div class="sidebar-brand sidebar-brand-sm">
            <a href="{{ route('homePage') }}">LS</a>
          </div>
          <ul class="sidebar-menu">
            <!-- <li class="menu-header">Dashboard</li> -->
            <li class="active"><a class="nav-link" href="{{ route('homePage') }}"><i class="fas fa-home"></i> <span>Home</span></a></li>
            <!-- <li class="nav-item dropdown">
              <a href="{{ route('homePage') }}" class="nav-link has-dropdown"><i class="fas fa-home"></i><span>Dashboard</span></a>
            </li> -->
            ...
            <!-- <li class="menu-header">Musyawarah</li> -->
            <li class="nav-item dropdown">
              <a href="#" class="nav-link has-dropdown" data-toggle="dropdown"><i class="fas fa-edit"></i> <span>Notulensi</span></a>
              <ul class="dropdown-menu">
                <li><a class="nav-link" href="layout-default.html"><i class="fas fa-file"></i>Buat Notulensi</a></li>
                <li><a class="nav-link" href="layout-default.html"><i class="fas fa-list"></i>Daftar Notulensi</a></li>
                <li><a class="nav-link" href="layout-transparent.html"><i class="fas fa-briefcase"></i>Daftar Pekerjaan</a></a></li>
              </ul>
            </li>
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu">
                <li><a class="nav-link" href="#"><i class="fas fa-box"></i>Tambah Aset</a></li>
                <li><a class="nav-link" href="#"><i class="fas fa-boxes"></i>Daftar Aset</a></li>
                <li><a class="nav-link" href="#"><i class="fas fa-tags"></i>Kategori Aset</a></a></li>
