...
<div class="main-content">
    <section class="section">
        ...
        <div class="section-header">
            <h1><i class="fa fa-list-alt"></i> Katalog</h1>
        </div>
        <div class="row">
            <div class="col-8">
                <div class="section-body" style="min-height: 300px;">
                    <div class="col-12" style="margin-left: 0px; margin-top: 0px; margin-bottom:20px; padding: 0px;">
                        <a href="#" class="btn btn-lg btn-info btn-primary" data-toggle="modal" data-target="#tambahModal"><i class="fas fas fa-plus"></i> Tambah Katalog</a>
                    </div>
