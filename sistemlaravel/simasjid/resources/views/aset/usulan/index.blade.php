    ...
    <section class="section">
        ...
        <div class="section-header">
            <div>
                ...
                <div>
                    <p style="padding: 10px; margin-bottom: 0px;">Usulan Barang berisi kumpulan usulan untuk barang aset yang telah dibuat oleh Takmir dan Remas.</p>
                </div>
            </div>
        </div>
        <div class="row">
            ...
            <div class="col-12">
                <div class="section-body" style="min-height: 300px;">
                    <div class="col-12" style="margin-left: 0px; margin-top: 0px; margin-bottom:20px; padding: 0px;">
                        <a href="{{ route('usulanCreate') }}" class="btn btn-lg btn-info btn-primary"><i class="fas fas fa-plus"></i> Buat Usulan</a>
                    </div>
                    <table id="table_id" class="table table-striped table-bordered">
                        <thead>
                            <tr>
                                <th class="dt-center">ID</th>
                                <th class="dt-center">Nama Usulan</th>
                                <th class="dt-center">Dibuat Oleh</th>
                                <th class="dt-center">Status</th>
                                <th class="dt-center" style="min-width: 5em;">Action</th>
                            </tr>
                        </thead>
                        <tbody>
                            @foreach ($usulanGroup as $usulanGroup)
                            <tr>
                                <td class="dt-center">{{ $usulanGroup->id }}</td>
                                <td class="dt-center"> {{ $usulanGroup->nama_usulan }} </td>
                                <td class="dt-center">{{ $usulanGroup->pembuat->nama }}</td>
                                <td class="dt-center font-status">{{ $usulanGroup->status}}</td>
                                <td class="dt-center">
                                    <a href="{{ route('home').'/aset/usulan/detail/' }}{{ $usulanGroup->id }}" class="btn btn-icon btn-sm btn-info" style="margin-bottom: 2px; width:100%;"><i class="fas fa-glasses"></i> Detail</a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
                ...
                <form method="POST" action="#">
                    ...
                    <div class="modal-body">
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="pengusul" type="text" class="form-control" name="pengusul" value="#" readonly disabled>
                                <input id="id_pengusul" type="text" class="form-control" name="id_pengusul" value="#" readonly hidden>
                            </div>
                        </div>
